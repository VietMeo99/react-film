        ...
        <div className="row ipad-width">
                  ...
                  <div className="row">
                    <div className="slick-multiItem">
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img src="images/uploads/mv-item4.jpg" alt="img"  />
                          </div>
                          <div className="hvr-inner">
                            <a href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright" /> </a>
                          </div>
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img src="images/uploads/mv-item5.jpg" alt="img"  />
                          </div>
                          <div className="hvr-inner">
                            <a href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright" /> </a>
                          </div>
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img src="images/uploads/mv-item6.jpg" alt="img"  />
                          </div>
                          <div className="hvr-inner">
                            <a href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright" /> </a>
                          </div>
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img src="images/uploads/mv-item7.jpg" alt="img"  />
                          </div>
                          <div className="hvr-inner">
                            <a href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright" /> </a>
                          </div>
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                          <div className="mv-img">
                            <img src="images/uploads/mv-item8.jpg" alt="img"  />
                          </div>
                          <div className="hvr-inner">
                            <a href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright" /> </a>
                          </div>
          ...
          <div className="col-md-4">
            <div className="sidebar">
              <div className="ads">
                <img src="images/uploads/ads1.png" alt="img" width={336} height={296} />
              </div>
              <div className="celebrities">
                <h4 className="sb-title">Spotlight Celebrities</h4>
                <div className="celeb-item">
                  <a href="#"><img src="images/uploads/ava1.jpg" alt="img" width={70} height={70} /></a>
                ...
                <div className="celeb-item">
                  <a href="#"><img src="images/uploads/ava2.jpg" alt="img" width={70} height={70} /></a>
                  <div className="celeb-author">
                ...
                <div className="celeb-item">
                  <a href="#"><img src="images/uploads/ava3.jpg" alt="img" width={70} height={70} /></a>
                  <div className="celeb-author">
                ...
                <div className="celeb-item">
                  <a href="#"><img src="images/uploads/ava4.jpg" alt="img" width={70} height={70} /></a>
                  <div className="celeb-author">
                    <h6><a href="#">Justin Weaver</a></h6>
                    <span>Actor</span>
                  </div>
                </div>
                <a href="#" className="btn">See all celebrities<i className="ion-ios-arrow-right" /></a>
              </div>
            </div>
          </div>
        </div>
