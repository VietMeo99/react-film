      ...
      <div className="container">
        <div className="row ipad-width">
          <div className="col-md-8">
            <div className="ads">
              <img src="images/uploads/ads2.png" alt="img" width={728} height={106} />
            </div>
            ...
            <div className="tabs">
              ...
              <div className="tab-content">
                <div id="tab31" className="tab active">
                  <div className="row">
                    <div className="blog-item-style-1">
                      <img src="images/uploads/blog-it1.jpg" alt="img" width={170} height={250} />
                ...
                <div id="tab32" className="tab">
                  <div className="row">
                    <div className="blog-item-style-1">
                      <img src="images/uploads/blog-it2.jpg" alt="img" width={170} height={250} />
                      <div className="blog-it-infor">
            ...
            <div className="morenew">
              <div className="title-hd">
                ...
                <a href="#" className="viewall">See all Movies news<i className="ion-ios-arrow-right" /></a>
              </div>
