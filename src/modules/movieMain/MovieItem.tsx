          ...
          <div className="row">
            <div className="col-md-12">
              <div className="hero-ct">
                <h1> Have fun watching the movie </h1>
                <ul className="breadcumb">
                  <li className="active"><Link to="/">Home</Link></li>
                  <li> <span className="ion-ios-arrow-right" /> Film </li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-9 col-sm-12 col-xs-12">
              <div className="blog-detail-ct">
                ...
                ></iframe>
                {/* <ReactPlayer width="97%" url='https://www.youtube.com/embed/3Zh6aSA0Nl0?autoplay=1' loop={true} /> */}
                <p>
                ...
                <div className="flex-it flex-ct">
                  ...
                  <img src="/images/uploads/blog-detail2.jpg" alt="img"/>
                </div>
                ...
                <div className="comments">
                  ...
                  <div className="cmt-item flex-it">
                    <img src="/images/uploads/author.png" alt="img"/>
                  ...
                  <div className="cmt-item flex-it reply">
                    <img src="/images/uploads/author2.png" alt="img"/>
                    <div className="author-infor">
                      <div className="flex-it2">
                  ...
                  <div className="cmt-item flex-it reply">
                    <img src="/images/uploads/author3.png" alt="img"/>
                    <div className="author-infor">
                      <div className="flex-it2">
                  ...
                  <div className="cmt-item flex-it">
                    <img src="/images/uploads/author4.png" alt="img"/>
                    <div className="author-infor">
                      <div className="flex-it2">
