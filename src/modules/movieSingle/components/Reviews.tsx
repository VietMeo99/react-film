...
const Reviews = () => {
  return (
    <div id="reviews" className="tab review" style={{display: "block"}}>
      <div className="row">
        <div className="rv-hd flex justify-between px-7">
          <div className="div">
        ...
        <div className="mv-user-review-item">
          <div className="user-infor">
            <img src="/images/uploads/userava1.jpg" alt="img"/>
            <div>
        ...
        <div className="mv-user-review-item">
          <div className="user-infor">
            <img src="/images/uploads/userava2.jpg" alt="img"/>
            <div>
        ...
        <div className="mv-user-review-item">
          <div className="user-infor">
            <img src="/images/uploads/userava3.jpg" alt="img"/>
            <div>
        ...
        <div className="mv-user-review-item ">
          <div className="user-infor">
            <img src="/images/uploads/userava4.jpg" alt="img"/>
            <div>
        ...
        <div className="mv-user-review-item last">
          <div className="user-infor">
            <img src="/images/uploads/userava5.jpg" alt="img"/>
            <div>
